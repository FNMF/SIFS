-- Normalize RBAC tables to the plural table names used by the backend:
-- roles, permissions, user_roles, role_permissions.
--
-- This script migrates compatible data from legacy singular tables if they
-- exist, seeds the default RBAC records, and drops the unused legacy tables.
